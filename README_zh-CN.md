...
Canbox 项目的静态网站，托管在 GitHub Pages。
...
- **应用管理**：支持应用的安装、卸载和更新
- **创建网页应用**：将任意网址封装为桌面应用，自动抓取 PWA manifest 信息预填名称/图标，支持 Chrome UA 伪装、菜单栏定制、导航快捷键（Alt+Left/Right）、缩放控制（Ctrl+=/-/0），PWA 的 Service Worker 离线缓存由 Chromium 原生支持；网页应用使用独立 userData，与平台数据完全隔离
- **APP 导入导出**：支持导入离线应用包，支持导出已安装应用供分享
- **快捷方式**：为常用应用创建桌面、开始菜单快捷方式，支持别名系统
- **自动更新**：支持 GitHub 自动更新，可配置检查频率
...
- 修改链接：在 `index.html` 中更新 GitHub 链接
